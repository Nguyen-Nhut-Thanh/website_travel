  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-[18px] text-slate-200 leading-relaxed font-medium">
            Sứ mệnh của chúng tôi là giúp mỗi chuyến đi của bạn không chỉ là một kỳ nghỉ, 
            mà là một câu chuyện đáng nhớ suốt đời.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-[32px] font-black text-slate-900 leading-tight">
                Hành trình từ niềm đam mê <br />đến nền tảng du lịch hàng đầu
              </h2>
              <p className="text-[16px] text-slate-600 leading-relaxed">
                Được thành lập từ năm 2015 bởi một nhóm những người trẻ yêu xê dịch, 
                Travol bắt đầu chỉ với một mong muốn đơn giản: Làm thế nào để việc khám phá Việt Nam trở nên dễ dàng và an toàn hơn cho tất cả mọi người.
              </p>
              <p className="text-[16px] text-slate-600 leading-relaxed">
                Hôm nay, Travol tự hào là một trong những nền tảng công nghệ du lịch tiên phong, 
                kết nối hàng triệu du khách với những trải nghiệm bản địa độc đáo nhất. Chúng tôi không ngừng mở rộng mạng lưới đối tác toàn cầu để mang cả thế giới đến gần bạn hơn.
              </p>
              
              <div className="grid grid-cols-2 gap-8 pt-4">
                {stats.map((s, i) => (
                  <div key={i} className="border-l-4 border-red-600 pl-4">
                    <p className="text-[28px] font-black text-slate-900 leading-none mb-2">{s.value}</p>
                    <p className="text-[13px] font-bold text-slate-500 uppercase tracking-wider">{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-20 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <span className="text-red-600 font-black uppercase text-[12px] tracking-[3px]">Triết lý hoạt động</span>
            <h2 className="text-[36px] font-black text-slate-900">Những giá trị định hình Travol</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v, i) => (
              <div key={i} className="bg-white p-8 rounded-[32px] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-slate-100 hover:-translate-y-2 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="space-y-8">
              ...
              <h2 className="text-[36px] md:text-[48px] font-black text-white leading-tight">
                Cam kết của chúng tôi <br />với du khách
              </h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=400" className="rounded-[30px] h-60 w-full object-cover" alt="Team 1" />
                <img src="https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&q=80&w=400" className="rounded-[30px] h-40 w-full object-cover" alt="Team 2" />
              </div>
              <div className="space-y-4 pt-12">
                <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=400" className="rounded-[30px] h-40 w-full object-cover" alt="Team 3" />
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=400" className="rounded-[30px] h-60 w-full object-cover" alt="Team 4" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 text-center">
        <h2 className="text-[32px] font-black text-slate-900 mb-8">Sẵn sàng để bắt đầu hành trình tiếp theo?</h2>
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link 
            href="/contact" 
            className="px-10 py-4 bg-white border-2 border-slate-900 text-slate-900 rounded-2xl font-black uppercase text-[14px] tracking-widest hover:bg-slate-900 hover:text-white transition-all active:scale-95"
          >
            Liên hệ tư vấn
          </Link>
        </div>
