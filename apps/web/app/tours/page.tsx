    ...
    <div className="mx-auto max-w-7xl">
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[280px_1fr]">
        <aside className="sticky top-8 h-fit space-y-6">
          <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)]">
            <h2 className="mb-6 flex items-center gap-2 text-lg font-bold uppercase tracking-tight text-gray-800">
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                className="mt-4 w-full rounded-xl bg-sky-500 px-4 py-3 text-[14px] font-bold text-white shadow-lg shadow-sky-100 transition-all hover:bg-sky-600 hover:shadow-sky-200 active:scale-[0.98]"
              >
                ÁP DỤNG BỘ LỌC
              </button>
            </div>
          ...
          <div className="rounded-xl border border-sky-100 bg-sky-50/30 p-4 text-center">
