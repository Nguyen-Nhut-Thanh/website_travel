      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
        {paginatedFavorites.map((fav) => {
          ...
          return (
            <div
              key={fav.tour_id}
              className="group overflow-hidden rounded-[1.75rem] border border-white/70 bg-white/90 shadow-[0_18px_60px_rgba(15,23,42,0.04)] transition-all hover:-translate-y-1 hover:shadow-[0_24px_80px_rgba(37,99,235,0.10)]"
            >
