...
export default function TourQuickInfo({ tour }: Props) {
  ...
  const highlightSummary = tour.sightseeing_summary?.trim();
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 space-y-5">
          <h3 className="text-center text-2xl font-black text-slate-900 md:text-[28px]">
            Điểm nổi bật của tour du lịch
          </h3>
          <div className="rounded-2xl border border-slate-100 bg-[#fbfcfe] p-6">
            <div className="rounded-2xl bg-white px-4 py-3">
            <div className="max-h-32 overflow-y-auto text-base leading-8 text-slate-700 custom-scrollbar md:text-lg">
              {highlightSummary ||
